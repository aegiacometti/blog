...
Check the previous [post](https://adriangiacometti.net/index.php/2020/04/13/free-cloud-network-backup-with-gui-and-messaging/) to view all the benefits you can have with this setup.
